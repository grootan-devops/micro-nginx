...
curl --fail --show-error --location --proto '=https' --tlsv1.2 --retry 3 --output "${CONTAINER_MOUNT}/tmp/${NGINX_RPM_FILE_NAME}" "https://nginx.org/packages/mainline/rhel/9/x86_64/RPMS/nginx-${NGINX_VERSION}-1.el9.ngx.x86_64.rpm"
